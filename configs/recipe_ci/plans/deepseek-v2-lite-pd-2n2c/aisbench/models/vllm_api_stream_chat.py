...
# Performance request configuration generated from the Recipe. Values that are
# only known at runtime, such as the gateway address, are injected by the Runner.
models = [
    dict(
        attr="service",
